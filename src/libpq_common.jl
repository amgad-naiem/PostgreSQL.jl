...
# end enum PGPing
const PQnoticeReceiver = Ptr{Nothing}
const PQnoticeProcessor = Ptr{Nothing}
const pqbool = UInt8
const pgthreadlock_t = Ptr{Nothing}
const PGconn = Nothing
const PGresult = Nothing

const _IO_FILE = Nothing
const FILE = Nothing
const PQconninfoOption = Nothing
const PGcancel = Nothing
const PGnotify = Nothing
const PQArgBlock = Nothing
const PGresAttDesc = Nothing
const PQprintOpt = Nothing
